      ...
      <main className="flex-1 ml-0 md:ml-[220px] px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="mb-6 sm:mb-10">
          ...
          <p className="text-gray-400 mt-2 text-sm sm:text-base">
            Enter your registration ID to check the approval status of your
            event application.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
          ...
          >
            ...
            {result && (
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                className="mt-5 sm:mt-6 border-t border-border pt-4 text-sm sm:text-base"
              >
                <p className="mb-2">
                  <b>Registration ID:</b> REG-{result.id}
                </p>

                <p className="mb-2">
                  <b>Event:</b> {result.event?.name}
                </p>
          ...
          >
            ...
            <ul className="space-y-2 sm:space-y-3 text-gray-300 text-xs sm:text-sm">
              <li>
                • After registering for an event you receive a Registration ID.
              </li>
              <li>
                • Format: <b>REG-1, REG-2, REG-10</b>
              </li>
              <li>• Use this ID to track approval status.</li>
              <li>• Approved registrations allow participation.</li>
            </ul>

            <div className="mt-4 sm:mt-6 p-3 sm:p-4 bg-slate-900/40 rounded-lg text-xs sm:text-sm text-gray-400">
              Tip: You can also view all your registrations in
